                        ...
                        <div class="card-body">
                          ...
                          @endif
                          	<div class="text-muted text-center mb-2">
                          		<small>{{ __('messages.textResetPass')}}</small>
                          	</div>
                          <form method="POST" action="{{ route('password.email') }}" autocomplete="off">
                            {{ csrf_field() }}
			                 <div class="form-group mb-2">
			                    <label class="text-bold-600" for="exampleInputEmailPhone1">{{ __('messages.email') }}</label>
			                    <input type="text" class="form-control {{ ($errors->has('email')) ? 'is-invalid' : '' }}" id="exampleInputEmailPhone1" name="email" placeholder="{{ __('messages.email') }}">
                          @if ($errors->has('email'))
		                  	...
		                  	<button type="submit" class="btn btn-cmetal glow position-relative w-100 ">{{ __('messages.enviarLink') }}
		                    <i id="icon-arrow" class="bx bx-right-arrow-alt"></i>
		                  	</button>
                          </form>
                          <hr>
                          <div class="text-center mb-2">
                            <a href="{{ route('iniciar-sesion') }}"><small class="text-muted">{{ __('messages.recordePass') }}</small></a>
                          </div>
                        </div>
                      </div>
                    </div>
