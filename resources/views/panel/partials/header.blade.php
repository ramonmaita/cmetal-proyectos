<div class="header-navbar-shadow"></div>
  <nav class="header-navbar main-header-navbar navbar-expand-lg navbar navbar-with-menu fixed-top navbar-dark bg-cmetal" data-bgcolor="bg-cmetal">
          ...
          <ul class="nav navbar-nav float-right">
            <li class="dropdown dropdown-language nav-item">
              <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <span class="selected-language">{{ __('messages.english') }}</span>
              </a>
              <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                <a class="dropdown-item" href="{{ route('lenguaje',['lenguaje' => 'en']) }}" data-language="en">
                  <i class="flag-icon flag-icon-us mr-50"></i> {{ __('messages.english') }}
                </a>
                <a class="dropdown-item" href="{{ route('lenguaje',['lenguaje' => 'es']) }}" data-language="es">
                  <i class="flag-icon flag-icon-es mr-50"></i>  {{ __('messages.spanish') }}
                </a>
              </div>
            </li>
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <span>
                  <div class="avatar mr-1 bg-warning bg-lighten-2">
                    <span class="avatar-content"><b>{{ substr(Auth::user()->nombre,0,1) }}{{ substr(Auth::user()->apellido,0,1) }}</b></span>
                  </div>
              ...
              <div class="dropdown-menu dropdown-menu-right pb-0">
                ...
                <a class="dropdown-item" href="{{ route('logout') }}"><i class="bx bx-power-off mr-50"></i> {{ __('messages.logout') }}</a>
              </div>
            </li>
          </ul>
        </div>
