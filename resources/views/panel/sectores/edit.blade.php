	...
	<div class="col-12">
  		<div class="card">
    		<div class="card-header">
      			<h4 class="card-title">{{ __('messages.editSector') }} </h4>
    		...
    		<div class="card-content collapse show">
      			<div class="card-body">
        			<div class="row">
          				<div class="col-sm-12">
          					@include('alertas')
            				<form class="form" method="POST" action="{{ route('sectores.update',['id' => $sector->id]) }}" autocomplete="off">
            					@method('PUT')
            					{{ csrf_field() }}
				              	<div class="form-body">
					                <div class="row"> 
					                  ...
					                  <div class="col-md-6 col-12">
					                    <div class="form-label-group">
					                      <input type="text" class="form-control  {{ ($errors->has('nombre_sector')) ? 'is-invalid' : '' }}" id="nombre_sector" placeholder="{{ __('messages.nombreSector') }}" name="nombre_sector" value="{{ $sector->nombre }}">
					                  ...
					                  <div class="col-md-6 col-12">
					                    <div class="form-label-group">
					                      <input type="text" id="descripcion"  class="form-control {{ ($errors->has('descripcion')) ? 'is-invalid' : '' }}" name="descripcion" placeholder="{{ __('messages.descripcion') }}" value="{{ $sector->descripcion }}">
